...
# setup Jinja2 template engine for serving static files (csv)
...
class DataForm:
    ...
    This class defines the vehicle-related attribute expected from the form.
    """
...
async def predictRouteClient(request: Request):
    """
    Endpoint to recieve data form, process it and make predictions.
    """
    try:
        ...
        # Convert form data into Dataframe for the model
        vehicle_df = vehicle_data.get_vehicle_data_dataframe()
