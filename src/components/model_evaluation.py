...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        Description: This model is used to evaluate trained model 
        ...
        try:
            ...
            trained_model = load_object(file_path=self.model_trainer_artifact.trainded_model_file_path)
            logging.info("Trained model exists")
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        On Failure: Write an exception and then raise an exception
        """
        try:
            print("-----------------------------------------------------------------------------------------------------------------")
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(is_model_accepted=evaluate_model_response.is_model_accepted,
                                                                ...
                                                                trained_model_path=self.model_trainer_artifact.trainded_model_file_path,
